...
public class DisplayNetworkPanel extends JPanel {
    ...
    public void update ( ) {
        ...
        JLabel networkName = new JLabel ( parent.getObserController ( ).observerNetwork.getName ( ) );
        ...
        gc.gridy = 2;
        gc.anchor = GridBagConstraints.PAGE_START;
        JLabel numberOfStation = new JLabel ( String.valueOf ( parent.getObserController ( ).observerNetwork.getTelescopes ( ).size ( ) ) );
