...
public class DisplayObserverView extends JPanel {
    final MainFrame parent;
    final GridBagConstraints gc = new GridBagConstraints ( );

    public DisplayObserverView ( MainFrame parent ) {
        this.parent = parent;
        ...
        for (TelescopeAzEl telescopeAzEl : parent.getObserController ( ).getModel ( ).getTelescopeAzElList ( )) {
